        ...
        <div className="game-fullscreen" style={{ background: landColor }}>
            ...
            <div className="floating-toolbar">
                <div className="toolbar-section">
                    ...
                    >
                        <FaRoad /> {BUILDING_TYPES['ROAD'].name} <span className="tool-cost">${BUILDING_TYPES['ROAD'].cost}</span>
                    </button>
                </div>
                ...
                <div className="toolbar-section">
                    ...
                    >
                        <FaHome /> {BUILDING_TYPES['HOUSE'].name} <span className="tool-cost">${BUILDING_TYPES['HOUSE'].cost}</span>
                    </button>
                </div>
                ...
                <div className="toolbar-section">
                    ...
                    >
                        <FaCoffee /> {BUILDING_TYPES['CAFE'].name} <span className="tool-cost">${BUILDING_TYPES['CAFE'].cost}</span>
                    </button>
                    <button
                        className={`floating-tool-btn ${cityState.selectedTool === 'OFFICE' ? 'active' : ''}`}
                        onClick={() => handleSelectTool('OFFICE')}
                    >
                        <FaBuilding /> {BUILDING_TYPES['OFFICE'].name} <span className="tool-cost">${BUILDING_TYPES['OFFICE'].cost}</span>
                    </button>
                    <button
                        className={`floating-tool-btn ${cityState.selectedTool === 'RESTAURANT' ? 'active' : ''}`}
                        onClick={() => handleSelectTool('RESTAURANT')}
                    >
                        <FaUtensils /> {BUILDING_TYPES['RESTAURANT'].name} <span className="tool-cost">${BUILDING_TYPES['RESTAURANT'].cost}</span>
                    </button>
                </div>
                ...
                <div className="toolbar-section">
                    ...
                    >
                        <FaShieldAlt /> {BUILDING_TYPES['POLICE'].name} <span className="tool-cost">${BUILDING_TYPES['POLICE'].cost}</span>
                    </button>
                    <button
                        className={`floating-tool-btn ${cityState.selectedTool === 'FIRE' ? 'active' : ''}`}
                        onClick={() => handleSelectTool('FIRE')}
                    >
                        <FaFireExtinguisher /> {BUILDING_TYPES['FIRE'].name} <span className="tool-cost">${BUILDING_TYPES['FIRE'].cost}</span>
                    </button>
